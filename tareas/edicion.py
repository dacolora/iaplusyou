...
def ejecutar_producir(tarea):
    ...
    # Como en final_edition/__init__.py: como mucho una corrida fallida por
    # destino queda en disco — un reintento siempre arranca de carpeta limpia
    # (_carpeta ya hizo su propio os.makedirs; lo repetimos después del
    # rmtree para dejarla vacía pero existente).
    ...
    try:
        ...
        # TikTok los meten en mensajes de excepción reales).
