...
def test_registro_contiene_swap_generar(base_temporal):
    ...
    assert sorted(tareas.REGISTRO) == [
        ...
        "flowplus_director", "flowplus_imagen", "flowplus_video", "materiales_limpiar", "meta_publicar", "meta_refrescar", "musica_generar", "nicho_generar_avatares", "nicho_inv_buscar", "nicho_inv_consultas", "nicho_inv_seleccionar", "nicho_recolectar", "organico_publicar", "producto_vincular",
